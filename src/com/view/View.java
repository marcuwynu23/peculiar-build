...
import com.builder.BatchRunner;
import com.builder.CommandLine;
import com.builder.ConfigLoader;
...
public class View extends Application implements SetApp {
    ...
    public void setAppUI() {
        ...
        mainPnl.setBackground(constant.P_COLOR);
        ...
        javaBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.T_COLOR, constant.X_COLOR);
        pythonBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.X_COLOR, constant.S_COLOR);
        jythonBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.T_COLOR, constant.X_COLOR);
        djangoBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.X_COLOR, constant.S_COLOR);
        kotlinBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.T_COLOR, constant.X_COLOR);
        nodeJSBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.X_COLOR, constant.S_COLOR);
        toolBuildBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.T_COLOR, constant.X_COLOR);
        cSharpBtn.setUI(constant.APP_BORDER, constant.M_FONT1, constant.X_COLOR, constant.S_COLOR);

        pecConfigBtn.setUI(constant.S_FONT, constant.X_COLOR, constant.S_COLOR);
