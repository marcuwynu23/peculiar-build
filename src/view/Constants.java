...
public class Constants {
    public final String APP_ICON_PATH = "resources/img/peculiar-project-builder.png";
    ...
    public final Color X_COLOR = new Color(45, 45, 45);
    public final Color BK_MAIN_COLOR = java.awt.Color.WHITE;
