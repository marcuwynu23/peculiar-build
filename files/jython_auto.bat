...
set COLOR=%4
set COLOR_ERROR=4
set WDIR=%MDIR%\JythonProjects
set JYTHON_STAND_JAR=%EDIR%\\Jython\lib\jython.jar
set APPLICATION_TITLE=Jython Project Builder
...
:main
	...
	color %COLOR%
	cls
	echo jython project automation:
	echo commands:                              
	echo.
...
:createProject
	...
	mkdir lib app  view model controller database test res
	...
	:runpy
		...
		start cmd /K java -jar %JYTHON_STAND_JAR% main.py
	goto runAsk
